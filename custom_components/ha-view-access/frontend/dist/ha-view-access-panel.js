...
function requireReactDomClient_production() {
  ...
  function beginWork(current, workInProgress2, renderLanes2) {
    ...
    switch (workInProgress2.tag) {
      ...
      case 24:
        return prepareToReadContext(workInProgress2), lazyComponent = readContext(CacheContext), null === current ? (init = peekCacheFromPool(), null === init && (init = workInProgressRoot, nextProps = createCache3(), init.pooledCache = nextProps, nextProps.refCount++, null !== nextProps && (init.pooledCacheLanes |= renderLanes2), init = nextProps), workInProgress2.memoizedState = {
...
const fetchLovelaceDashBoard = (urlPath) => getHass().callWS({
  type: "lovelace/config",
  url_path: urlPath
});
const saveLovelaceDashBoard = (config2) => getHass().callWS({
  type: "lovelace/config/save",
  url_path: config2.url,
  config: config2
});
const fetchAuthList = () => getHass().callWS({
  type: "config/auth/list"
});
const fetchLovelacePanels = () => getHass().callWS({
  type: "get_panels"
});
var md5$1 = { exports: {} };
...
const StyledTableCell = styled(TableCell)(({ theme: theme2 }) => ({
...
const StyledTableRow = styled(TableRow)(({ theme: theme2 }) => ({
  "&:nth-of-type(odd)": {
...
const UserViewGrid = () => {
  ...
  const [dashboards, setDashboards] = reactExports.useState([]);
  ...
  const getUsers = async () => {
    const users2 = (await fetchAuthList()).filter((user) => !user.system_generated).sort((u1, u2) => (u1.username ?? "") < (u2.username ?? "") ? -1 : 1);
    setUsers(users2);
    setSelectedUserIds(users2.map((user) => user.id));
  };
  const getDashboards = async () => {
    const allUserIds = users.map((user) => user.id);
    const rawPanels = await fetchLovelacePanels();
    const lovelacePanels = [null];
    ...
    return await Promise.all(lovelacePanels.map((urlPath) => new Promise((resolve, reject) => {
        ...
        resolve({
          ...
          views: raw.views.map((view, index) => {
            return {
              title: view.title,
              index,
              visibility: view.visible === void 0 ? allUserIds : view.visible.map((value) => value.user)
            };
          })
        });
      });
  ...
  if (dashboards.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { children: "Loading" });
  }
  const cloneDashboardAndSanitizeVisibility = (initialDashboard, viewIndex) => {
  ...
  const dashboardHasChangedSignature = async (dashboard) => {
  ...
  const addUserFromView = async (initialDashboard, viewIndex, userId) => {
  ...
  const removeUserFromView = async (initialDashboard, viewIndex, userId) => {
    const dashboard = cloneDashboardAndSanitizeVisibility(initialDashboard, viewIndex);
    if (await dashboardHasChangedSignature(initialDashboard)) {
      setSnackBarMessage("Has changed");
      await refreshDashboards();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Snackbar,
      {
        ...
        message: "Error",
        action: /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { color: "secondary", size: "small", onClick: handleCloseSnackbar, children: snackBarMessage }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            IconButton,
            {
              size: "small",
    ...
    users == null ? void 0 : users.map((user) => /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Checkbox,
        {
          ...
          onChange: () => {
            ...
            setSelectedUserIds(selectedUserIds.map((user2) => user2));
          }
        }
      ),
      user.name
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TableContainer, { component: Paper, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { size: "small", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledTableRow, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StyledTableCell, {}),
        users == null ? void 0 : users.filter((user) => selectedUserIds.includes(user.id)).map((user) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          StyledTableCell,
          {
            align: "center",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: dashboards.map((dashboard) => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledTableRow, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(StyledTableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { fontWeight: "bold", children: dashboard.url ?? "default" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StyledTableCell, { colSpan: users == null ? void 0 : users.length, children: " " })
        ] }),
        dashboard.views.map((view) => /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledTableRow, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledTableCell, { children: [
            "- ",
            view.title
          ] }),
          users == null ? void 0 : users.filter((user) => selectedUserIds.includes(user.id)).map((user) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              align: "center",
              children: view.visibility.includes(user.id) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  onClick: () => removeUserFromView(dashboard, view.index, user.id),
                  children: "X"
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => addUserFromView(dashboard, view.index, user.id), children: "-" })
            }
          ))
        ] }))
      ] })) })
...
function MenuAppBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Tabs,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tab, { style: { color: "#FFFFFF" }, label: "Views access", sx: { textTransform: "none", fontWeight: "bold" } })
    }
  );
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MenuAppBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(UserViewGrid, {})
  ] });
}
var browser;
...
const DialogsContext = /* @__PURE__ */ reactExports.createContext(null);
...
function DialogsProvider(props) {
  ...
  const keyPrefix = reactExports.useId();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogsContext.Provider, {
    value: contextValue,
...
const PanelRoot = () => class extends HTMLElement {
  constructor() {
    super();
    __publicField(this, "_root");
    this._root = ReactDOM$1.createRoot(this);
    const props = {
      hass: {
        set(value) {
          setHass(value);
  ...
  _render() {
    this._root.render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogsProvider, { children: [
...
//# sourceMappingURL=ha-view-access-panel.js.map
